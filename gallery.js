...
document.querySelectorAll("video[data-src]").forEach(video => {
    ...
    function resizeImages() {
        const galleryLines = document.querySelectorAll('.gallery-line');
    
        galleryLines.forEach(line => {
            const mediaElements = line.querySelectorAll('.gallery-media');
    ...
    const mediaElements = document.querySelectorAll('.gallery-media');
