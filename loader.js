document.addEventListener('DOMContentLoaded', () => {
    ...
    const loaderHTML = `
        <div id="whitelake-preloader">
            <div class="loader-inner">
                ...
                <div id="full-brand-logo-loader">WhiteLakeViz</div>
            </div>
        </div>`;
    ...
    const fullBrandLogo = document.getElementById('full-brand-logo-loader');
    ...
    function startReveal() {
        ...
        setTimeout(() => {
            ...
            const fullWidth = fullBrandLogo.scrollWidth;
            fullBrandLogo.classList.add('reveal');
            fullBrandLogo.style.width = (fullWidth + 30) + "px";
